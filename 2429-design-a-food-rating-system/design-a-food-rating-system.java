class FoodRatings {
    ...
    class Pair implements Comparable<Pair> {
        ...
        public int compareTo(Pair obj) {
            if (this.rating != obj.rating) return obj.rating - this.rating;
    ...
    public FoodRatings(String[] foods, String[] cuisines, int[] ratings) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (!cuisineToRatingsMap.containsKey(cuisines[i])) cuisineToRatingsMap.put(cuisines[i], new PriorityQueue<>());
